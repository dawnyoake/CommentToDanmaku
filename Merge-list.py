...
class AppConfig:
    # 输入输出路径
    video_path: str = r"E:\R-User-File\R-Project-Myself\CommentCatcher\kirinuki\03\03-mask-full.mp4"
    excel_path: str = r"E:\R-User-File\R-Project-Myself\CommentCatcher\kirinuki\03\03-comment-translation.xlsx"
    output_path: str = r"E:\R-User-File\R-Project-Myself\CommentCatcher\kirinuki\03\03-danmu-full-start.mp4"
    ...
    # 弹幕参数
    start_comment_index: int = 23
    gamestart = 370
    gameend = 1888 - start_comment_index
    ...
    # FFmpeg参数
    ffmpeg_preset: str = 'slow'      # slow, fast
